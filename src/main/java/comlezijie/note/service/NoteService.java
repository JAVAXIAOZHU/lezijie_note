package comlezijie.note.service;

import cn.hutool.core.util.StrUtil;
import comlezijie.note.dao.NoteDao;
import comlezijie.note.po.Note;
import comlezijie.note.util.Page;
...
public class NoteService {
    ...
    public ResultInfo<Note> addOrUpdate(String typeId, String title, String content,String noteId,String lon,String lat) {
        ...
        //设置经纬度的默认值 默认值设置为北京 116.404,39.915
     ...
     * @param pageSizestr
     * @param userId
     * @param title 传递的参数： 标题
     * @param date 传递的参数： 日期
     * @param typeId 传递的参数： 参数ID
     * @return
     */
